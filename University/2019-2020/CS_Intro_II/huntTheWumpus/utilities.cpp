...
/*************************************************************************************************
FUNCTION NAME: get_int_in_range
FUNCTION DESCRIPTION: use this to get an integer between two values
INPUTS: low bound, high bound, prompt
OUTPUTS: returns the integer the user entered if it is in range
**************************************************************************************************/
int get_int_in_range(string prompt, int low, int high) {
	int x = 0;

	while (x < low || x > high) 
		x = get_int_input(prompt);
