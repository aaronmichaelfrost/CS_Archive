...
Display( )
{
	...
	SetPointLight(GL_LIGHT0, -movingX, 0., 1.5, 1, 1, 1);
	glPushMatrix();
	glColor3f(1, 1, 1);
	glTranslatef((GLfloat)-movingX, (GLfloat)0, (GLfloat)1.5);
	OsuSphere(.1, 6, 6);
	glPopMatrix();

	SetPointLight(GL_LIGHT1, 1, 1, 1, cos(movingX), sin(movingX), sin(-movingX));
	glPushMatrix();
	glColor3f(cos(movingX), sin(movingX), sin(-movingX));
	glTranslatef((GLfloat)1, (GLfloat)1, (GLfloat)1);
	OsuSphere(.1, 6, 6);
	glPopMatrix();
	 
	SetSpotLight(GL_LIGHT2, -1, 1, 1, 1, sin(8 * movingX), -1, 1, 1, 1);
	glPushMatrix();
	glColor3f(1, 1, 1);
	glTranslatef((GLfloat)-1, (GLfloat)1, (GLfloat)1);
	OsuSphere(.1, 6, 6);
...
InitGraphics( )
{
	...
	texture = BmpToTexture("mars.bmp", &textureWidth, &textureHeight);
}
