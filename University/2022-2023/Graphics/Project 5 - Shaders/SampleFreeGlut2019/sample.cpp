...
float Time;
bool useVertPattern = true;
bool useFragPattern = true;
...
Display( )
{
	...
	SetPointLight(GL_LIGHT0, 5, 5., 0., 1., 1., 1.);
	...
	Pattern->SetUniformVariable("uSpecularColor", R, G, B);
	...
	Pattern->SetUniformVariable("vertPattern", useVertPattern);
	Pattern->SetUniformVariable("fragPattern", useFragPattern);
...
Keyboard( unsigned char c, int x, int y )
{
	...
	switch( c )
	{
		...
		case 'f':
			useFragPattern = false;
			useVertPattern = false;
			break;
