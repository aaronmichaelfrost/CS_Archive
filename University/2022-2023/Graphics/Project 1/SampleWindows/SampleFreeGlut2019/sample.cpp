...
GLuint	LeftPropellerList;				// object display list
GLuint	RightPropellerList;				// object display list
GLuint	FrontPropellerList;				// object display list
...
InitLists( )
{
	...
	RightPropellerList = glGenLists(1);
	glNewList(RightPropellerList, GL_COMPILE);
	...
	radius = 5;
	// Draw center propeller
	FrontPropellerList = glGenLists(1);
	glNewList(FrontPropellerList, GL_COMPILE);
