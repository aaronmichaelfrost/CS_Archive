...
void queue_enqueue(struct queue* queue, void* val) {
  ...
  dynarray_circular_insert(queue->array, val);
...
void* queue_front(struct queue* queue) {
  ...
  return dynarray_get(queue->array, dynarray_get_logicalstart(queue->array));
}
...
void* queue_dequeue(struct queue* queue) {
  void* temp = queue_front(queue);

  dynarray_set_logicalstart(queue->array, dynarray_get_logicalstart(queue->array) + 1);

  dynarray_set_size(queue->array, dynarray_size(queue->array) - 1);
