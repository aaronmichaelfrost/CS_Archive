///
///		dec_server.c
///		Decryption server. Made to use with a dec_client. 
...
/// <summary>
/// Undo encryption that is performed in enc_server.c
/// </summary>
/// <param name="message">String to decrypt and output</param>
/// <param name="key">Secret key to decrypt message</param>
void decrypt(char* message, char* key) {
    ...
    for (i = 0; i < len; i++)
    {
        int temp = char_to_int(message[i]) - char_to_int(key[i]);
...
int main(int argc, char* argv[]) {
    ...
    while (1) {
        ...
        // Create child process to perform decryption
        pid = fork();
        ...
        case 0: {
            ...
            // Client should send the mode string "d" for decrypt
            ...
            // If the client wants to encrypt, they are connected to the wrong server
